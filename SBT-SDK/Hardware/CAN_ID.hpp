...
enum class ParameterId : uint16_t {
    ...
    kls_current, // Actual motor current              int32_t     0,1A 0,0 -
                 // 400,0
    kls_bateryVoltage, // Actual batery voltage             int32_t     0,1V 0,0
                       // - 180,0
    kls_throtleSignal, // Throtle signal                    int32_t      V 0~255
                       // maps 0~5V
    kls_controllerTemperature, // Controller temperature            int32_t *C
                               // (offset 40)
    kls_motorTemperature, // Controller temperature            int32_t     *C
                          // (offset 30)
