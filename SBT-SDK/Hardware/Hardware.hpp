...
// problem
namespace Gpio {
enum class Mode { Input, Output, AlternateInput, AlternatePP, AlternateOD };

enum class Pull { Pullup = 1, PullDown = 2, NoPull = 0 };
} // namespace Gpio
...
struct Hardware {
   ...
   */
  static void enableGpio(GPIO_TypeDef* gpio, uint32_t pin, Gpio::Mode direction,
