...
void Hardware::configureClocks(uint32_t ahbFreq) {
  ...
  static const auto calculateBestAHBPrescalerAndPLLMUL =
    ...
    // Calculate theoretical AHB frequency based on passed parameters. Return
    // nullopt if frequency is higher than 72MHz
    static const auto calculateAHBFreq =
        [](uint32_t PLLMUL, uint32_t AHBPrescaler) -> std::optional<uint32_t> {
    ...
    constexpr std::array possiblePLLMUL = {
        std::make_pair(4, RCC_PLL_MUL4),   std::make_pair(5, RCC_PLL_MUL5),
        std::make_pair(6, RCC_PLL_MUL6),   std::make_pair(7, RCC_PLL_MUL7),
        std::make_pair(8, RCC_PLL_MUL8),   std::make_pair(9, RCC_PLL_MUL9),
        std::make_pair(10, RCC_PLL_MUL10), std::make_pair(11, RCC_PLL_MUL11),
        std::make_pair(12, RCC_PLL_MUL12), std::make_pair(13, RCC_PLL_MUL13),
        std::make_pair(14, RCC_PLL_MUL14), std::make_pair(15, RCC_PLL_MUL15),
